    ...
    public function closeExpired()
{
    ...
    public function testNotification()
    {
        try {
            ...
            // Usar el token más reciente (el último actualizado)
            $userDb = new \App\Models\UserModel;
            $users = $userDb->where('fcm_token IS NOT NULL', null, false)
            ...
            return $this->respond([
                ...
                'username'   => $users['username'], // ← para saber a quién se envió
            ]);
        } catch (\Throwable $e) {
